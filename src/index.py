...
net = net.to(DEVICE)
load_checkpoint("/scratch/am8949/SIGIR2021/colbert-test-100000.dnn", net)
net.eval()
...
with open(COLLECTION + '/queries-2019-qw.txt', 'w') as g:
    with open(COLLECTION + '/msmarco-test2019-queries.filtered.tsv') as f:
